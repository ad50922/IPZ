...
class GazeController:
    ...
    def calculate(self, frame, do_calibration=False, reset_calibration=False, moving_point_frame=None):
        ...
        moving_point_frame_out = np.array(moving_point_frame)
        if moving_point_frame is not None:
            if lr_mean_distance is not None and ud_mean_distance is not None:
                moving_point_frame_out = self._moving_point_feedback_draw(moving_point_frame_out, True,
                                                                          lr_mean_distance, ud_mean_distance)
            else:
                moving_point_frame_out = self._moving_point_feedback_draw(moving_point_frame_out, False)
        else:
            if lr_mean_distance is not None and ud_mean_distance is not None:
                frame = self._moving_point_feedback_draw(frame, True,
                                                         lr_mean_distance, ud_mean_distance)
            else:
                frame = self._moving_point_feedback_draw(frame, False)
        ...
        return {
            ...
            "moving_point_frame": moving_point_frame_out
        }